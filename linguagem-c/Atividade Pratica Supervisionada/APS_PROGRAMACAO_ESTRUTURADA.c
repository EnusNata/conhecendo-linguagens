...
//Faça um programa para o cadastro de produtos de uma loja. Seu
...
//encerrar o cadastro de produtos, o programa deve percorrer o arquivo
//que foi criado, apresentar os produtos com o maior preço e ao final
//imprimir todos os produtos cadastrados.
//Obs.: Os produtos cadastrados não podem ter códigos repetidos.
...
/* O TERMO PRIMARY KEY É UTILIZADO EM BANCO DE DADOS COMO O NOME DADO AO CAMPO QUE IDENTIFICA TODO UM REGISTRO , ELE DEVE SER UNICO PARA CADA
   REGISTRO ,NORMALMENTE ESTE CAMPO ESTÁ SOBRE EFEITO DE UMA CONSTRAINT CHAMADA AUTO_INCREMENT, CUJA QUAL NÃO PERMITE QUE ESTE SEJA DEFINIDA 
   PELO USUARIO, PORTANTO UTILIZEI ESSE CONCEITO AQUI EM PROGRAMAÇÃO ESTRUTURADA POIS ESTE SE ENCAIXA PERFEITAMENTE COM ESTE EXERCICIO / APS.
*/
