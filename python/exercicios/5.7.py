...
frutas = ['laranja','banana','manga','maca','pera','uva']
frutas_favoritas = ['maracuja','pessego','manga']

for fruta_favorita in frutas_favoritas:
    if fruta_favorita in frutas:
        print('voce realmente gosta de {}'.format( fruta_favorita ))
    else:
        continue
