...
names = ['nathan','suellen','wenderson','vitin']

print('seja bem vindo {}'.format( names[0] ))
print('seja bem vindo {}'.format( names[1] ))
print('seja bem vindo {}'.format( names[2] ))
print('seja bem vindo {}'.format( names[3] ))